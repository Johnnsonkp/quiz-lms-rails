        ...
        <ul className="flex text-gray-600 gap-1 text-xs cursor-pointer">
          <div className="relative flex w-[100%] cursor-pointer h-[100%]">
            ...
            <li 
              ...
              flex mx-auto z-1 w-1/3 rounded-md text-center justify-center align-middle items-center h-full" 
            ...
            <li className="hover:text-black cursor-pointer py-[0.2rem] relative 
              flex mx-auto z-1 w-1/3 rounded-md text-center justify-center align-middle items-center" 
