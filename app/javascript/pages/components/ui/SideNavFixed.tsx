...
function SideNavFixed() {
  return (
    <div className="flex flex-col items-center w-12 h-full overflow-hidden text-gray-400 bg-gray-900 rounded shadow-md">
      <div className="flex items-center justify-center mt-3" >
        <AppLogo showSidebar={true} showTitle={false} />
      </div>
      <div className="flex flex-col items-center mt-3 border-t border-gray-700">
        ...
        <a className="flex items-center justify-center w-12 h-12 mt-2 text-gray-200 bg-gray-700 rounded" href="#">
          <svg className="w-6 h-6 strokeCurrent" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
            stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
