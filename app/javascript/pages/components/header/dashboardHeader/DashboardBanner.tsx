  ...
  return (
    <header className="p-0 mx-auto relative h-[150px] w-[100%] mb-5 mt-0 shadow-md rounded-lg bg-[#D1D7E3]">
      <button
        ...
        // className="p-2 rounded-full hover:bg-white/20 transition-colors absolute top-2 left-2 flex align-middle items-center cursor-pointer text-bold z-30 text-white backdrop-blur-sm bg-black/20 bg-white/10 !text-blue-500 text-sm px-3 hover:text-black/80"
         className="p-2 rounded-full hover:bg-white/20 transition-colors absolute top-2 left-2 flex align-middle items-center cursor-pointer text-bold z-30  backdrop-blur-sm bg-white/10 text-blue-500 text-sm px-3 hover:text-black/70 w-[180px]"
      >
        {/* <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 19l-7-7 7-7" />
        </svg> */}
        {/* <svg width="5%" height="5%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"> */}
        <svg width="13%" height="" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
